...
export class DateTimeComponent extends AbstractComponent implements OnInit, RightKindInterface {
    ...
    ngOnInit() {
        console.log(this.menuDetailData);
        this.initDateTimePicker();
    }

    public setHourList(): void {
    ...
    public initDateTimePicker() {
        ...
        if ( _.has(this.menuDetailData, 'fltrVal') ) {
            let date = this.menuDetailData.fltrVal[0].code;
            ...
            if ( _.size(splitList) == 2 ) {
                ...
                this.usedHour = this.menuDetailData.usedHour;
            }
    ...
    public getFilterData(): any {
        ...
        if ( start != null && end != null ) {
            ...
            if(this.menuDetailData.druidNm.indexOf('tmap') > -1) {
                if( interval > 24 ) {
