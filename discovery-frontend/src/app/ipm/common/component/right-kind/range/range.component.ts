...
export class RangeComponent extends AbstractComponent implements OnInit, RightKindInterface {
  ...
  ngOnInit() {
    ...
    this.step = Number(this.menuDetailData.fltrDtlList[0].step) || null;
   ...
   * @param i (2개 input box 구분 - 0: 시작, 1: 종료)
   */
